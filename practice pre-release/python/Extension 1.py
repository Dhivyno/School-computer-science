import random
menu_question = int(input("Type 1 if you want to play against computer and 2 if you want to play multiplayer"))
...
if comp_wins < player_wins:
 print("player won overall with", player2_wins, "wins")
if comp_wins == player_wins:
 print("it's a tie overall")
