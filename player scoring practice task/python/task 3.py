...
highest = 0
for i in range(30):
 if successlist[i] > highest:
   highest = successlist[i]
   index = i
print("The player with the highest success has", highest, "points and their name is", names[index], "with", shots[index], "shots,", assists[index], "assists and", goals[index], "goals")
